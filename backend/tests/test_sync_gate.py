...
def _rehearsal_body(**ctx):
    ...
    return {
        **ctx,
        ...
        "child_behavior_affect": {"pleasure": 0, "arousal": 0, "dominance": 0, "confusion": 1, "frustration": 1, "boredom": 1},
        "self_handling_affect": {"pleasure": 1, "arousal": -1, "dominance": 0, "confusion": 3, "frustration": 4, "boredom": 5},
    }
...
def test_loop_gates_post_kid_response_and_post_feedback(client, protocol_id):
    ...
    client.post(
        f"/sessions/{sid}/self-reports",
        json={"loop_index": 2, "phase": "feedback", "timepoint": "post", "function_class": "NR", "pleasure": 0, "arousal": 0, "dominance": 0, "confusion": 1, "frustration": 1, "boredom": 1},
    )
...
def test_post_kid_response_gate_needs_the_self_handling_row(client, protocol_id):
    ...
    client.post(
        f"/sessions/{sid}/self-reports",
        json={"loop_index": 2, "phase": "rehearsal", "timepoint": "post", "function_class": "NR", "pleasure": 0, "arousal": 0, "dominance": 0, "confusion": 1, "frustration": 1, "boredom": 1},
    )
    assert _go(client, sid, scope="loop", loop_index=2, checkpoint="post_kid_response")["proceed"] is False
